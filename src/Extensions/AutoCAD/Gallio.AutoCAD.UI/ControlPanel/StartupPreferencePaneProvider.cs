...
{
    /// <summary>
    /// Provides the preference pane for AutoCAD startup options.
    /// </summary>
    public class StartupPreferencePaneProvider : IPreferencePaneProvider
    {
        ...
        {
            return new StartupPreferencePane(preferenceManager);
        }
    }
}
