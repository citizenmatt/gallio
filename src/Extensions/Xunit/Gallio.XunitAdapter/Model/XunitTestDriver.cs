...
{
    /// <summary>
    /// Explores and runs tests in Xunit assemblies.
    /// </summary>
    internal class XunitTestDriver : SimpleTestDriver
    {
        ...
        protected override TestController CreateTestController()
        {
            ...
            {
                var topTest = test as XunitTest;
                return topTest != null ? new XunitTestController() : null;
            });
        }
    }
}
