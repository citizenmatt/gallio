...
namespace Gallio.Tests.Reports
{
    ...
    public class VtlReportFormatterTest
    {
        ...
        public void Constructs_with_null_preferenceManager_should_throw_exception()
        {
            new VtlReportFormatter(null, "ext", MimeTypes.PlainText, new DirectoryInfo("content"), "vm", EmptyArray<string>.Instance, true);
        }
        ...
        public void Constructs_with_null_extension_should_throw_exception()
        {
            ...
            new VtlReportFormatter(fakeReportPreferenceManager, null, MimeTypes.PlainText, new DirectoryInfo("content"), "vm", EmptyArray<string>.Instance, true);
        }
        ...
        public void Constructs_with_null_contentType_should_throw_exception()
        {
            var mockPreferenceManager = MockRepository.GenerateStub<IPreferenceManager>();
            var fakeReportPreferenceManager = new ReportPreferenceManager(mockPreferenceManager);
            new VtlReportFormatter(fakeReportPreferenceManager, "ext", null, new DirectoryInfo("content"), "vm", EmptyArray<string>.Instance, true);
        }
        ...
        public void Constructs_with_null_resourceDirectory_should_throw_exception()
        {
            var mockPreferenceManager = MockRepository.GenerateStub<IPreferenceManager>();
            var fakeReportPreferenceManager = new ReportPreferenceManager(mockPreferenceManager);
            new VtlReportFormatter(fakeReportPreferenceManager, "ext", MimeTypes.PlainText, null, "vm", EmptyArray<string>.Instance, true);
        }
        ...
        public void Constructs_with_null_templatePath_should_throw_exception()
        {
            var mockPreferenceManager = MockRepository.GenerateStub<IPreferenceManager>();
            var fakeReportPreferenceManager = new ReportPreferenceManager(mockPreferenceManager);
            new VtlReportFormatter(fakeReportPreferenceManager, "ext", MimeTypes.PlainText, new DirectoryInfo("content"), null, EmptyArray<string>.Instance, true);
        }
        ...
        public void Constructs_with_null_resourcePaths_should_throw_exception()
        {
            var mockPreferenceManager = MockRepository.GenerateStub<IPreferenceManager>();
            var fakeReportPreferenceManager = new ReportPreferenceManager(mockPreferenceManager);
            new VtlReportFormatter(fakeReportPreferenceManager, "ext", MimeTypes.PlainText, new DirectoryInfo("content"), "vm", null, true);
        }
        ...
        public void Constructs_with_null_resource_containing_null_element_should_throw_exception()
        {
            var mockPreferenceManager = MockRepository.GenerateStub<IPreferenceManager>();
            var fakeReportPreferenceManager = new ReportPreferenceManager(mockPreferenceManager);
            new VtlReportFormatter(fakeReportPreferenceManager, "ext", MimeTypes.PlainText, new DirectoryInfo("content"), "vm", new string[] { null }, true);
        }
