...
{
    [TestFixture]
    [TestsOn(typeof(CharFormattingRule))]
    public class CharFormattingRuleTest : BaseFormattingRuleTest<CharFormattingRule>
    {
        [Test]
        [Row('x', "'x'")]
        [Row('\n', "'\\n'")]
        ...
        [Test]
        [Row(typeof(char), FormattingRulePriority.Best)]
