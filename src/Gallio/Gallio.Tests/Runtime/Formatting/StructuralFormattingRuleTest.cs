...
namespace Gallio.Tests.Runtime.Formatting
{
    ...
    public class StructuralFormattingRuleTest : BaseFormattingRuleTest<StructuralFormattingRule>
    {
        ...
        public void Format()
        {
            ...
            string expectedResult = "{Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {42}, Left = null, Property = {101}, ReadOnlyProperty = {blah}, Right = null}";
        ...
        public void Format_CyclicGraphShouldPrintPlaceholderForObjectAndNotCauseStackOverflowException()
        {
            ...
            string expectedResult = "{Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {0}, Left = {...}, Property = {0}, ReadOnlyProperty = {blah}, Right = null}";
            Assert.AreEqual(expectedResult, Formatter.Format(value));
        }
        ...
        public void Format_DeepGraphShouldStopAfterTwoLevels()
        {
            ...
            string expectedResult = "{Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {1}, Left = {Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {2}, Left = {...}, Property = {0}, ReadOnlyProperty = {blah}, Right = null}, Property = {0}, ReadOnlyProperty = {blah}, Right = null}";
            Assert.AreEqual(expectedResult, Formatter.Format(value));
        }
        ...
        public void Format_ShouldRemoveObjectFromReentanceVisitedSetWhenAllPrinted()
        {
            ...
            string expectedResult = "{Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {0}, Left = null, Property = {0}, ReadOnlyProperty = {blah}, Right = null}";
            Assert.AreEqual(expectedResult, Formatter.Format(value));
        ...
        public void Format_ShouldUseReferentialEqualityForDeterminingReentrance()
        {
            ...
            string expectedResult = "{Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {1}, Left = {Gallio.Tests.Runtime.Formatting.StructuralFormattingRuleTest+SampleObject: Field = {1}, Left = null, Property = {0}, ReadOnlyProperty = {blah}, Right = null}, Property = {0}, ReadOnlyProperty = {blah}, Right = null}";
