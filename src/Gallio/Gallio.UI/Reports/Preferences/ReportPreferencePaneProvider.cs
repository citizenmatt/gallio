...
namespace Gallio.UI.Reports.Preferences
{
    ...
    /// 
    /// </summary>
    public class ReportPreferencePaneProvider : IPreferencePaneProvider
    {
        ...
        public ReportPreferencePaneProvider(ReportPreferenceManager preferenceManager)
        {
        ...
        {
            return new ReportPreferencePane
            {
