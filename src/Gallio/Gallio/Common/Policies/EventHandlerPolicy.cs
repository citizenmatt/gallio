...
namespace Gallio.Common.Policies
{
    ...
    /// <see cref="EventHandler{T}"/> and reporting unhandled exceptions in event
    /// handlers safely via <see cref="UnhandledExceptionPolicy"/>.
    /// </summary>
    public static class EventHandlerPolicy
    {
        /// <summary>
