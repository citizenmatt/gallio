...
namespace Gallio.Common.Validation
{
    ...
    /// code that throws <see cref="ArgumentException"/> for that instead.  The validation
    /// utilities are intended for use by self-validating <see cref="IValidatable"/> objects
