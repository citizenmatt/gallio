...
{
    /// <summary>
    /// A test isolation provider creates <see cref="ITestIsolationContext" /> instances.
    /// </summary>
    public interface ITestIsolationProvider
    {
        /// <summary>
        ...
        ITestIsolationContext CreateContext(TestIsolationOptions testIsolationOptions, ILogger logger);
    }
}