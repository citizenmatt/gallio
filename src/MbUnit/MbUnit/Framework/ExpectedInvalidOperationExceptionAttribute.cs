...
{
    /// <summary>
    /// Declares that the associated test is expected to throw an <see cref="InvalidOperationException" />.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public class ExpectedInvalidOperationExceptionAttribute : ExpectedExceptionAttribute
    {
        ...
        /// Declares that the associated test is expected to throw an <see cref="InvalidOperationException" />.
        /// </summary>
        public ExpectedInvalidOperationExceptionAttribute()
        ...
        public ExpectedInvalidOperationExceptionAttribute(string message)
            : base(typeof(InvalidOperationException), message)
        {
        }
    }
}